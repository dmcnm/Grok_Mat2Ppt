classdef ST_TextFontScalePercentOrPercentString
%ST_TEXTFONTSCALEPERCENTORPERCENTSTRING  Ported from python-pptx 1.0.2: oxml/simpletypes.py::ST_TextFontScalePercentOrPercentString
    methods (Static)
