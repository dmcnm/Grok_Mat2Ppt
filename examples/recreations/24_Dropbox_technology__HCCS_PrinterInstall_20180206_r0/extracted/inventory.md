# Inventory: 24_Dropbox_technology__HCCS_PrinterInstall_20180206_r0.pptx

Slides: 7
Assets: ['image2.jpeg', 'image3.jpg', 'image4.png', 'image5.png', 'image6.png', 'image7.png', 'image8.png']
...
- `sp` prst=None (790575,1122363) 10858499x2387600 asset= text='HCCS Network Printer Installation'
- `sp` prst=None (1524000,3602038) 9144000x1655762 asset= text='Douglas CoombsFebruary 6, 2018, Rev. 0'
...
- `sp` prst=rect (5306752,3566567) 647700x202181 asset= text=''
...
- `pic` prst=rect (6539564,1994356) 5417084x3967928 asset=image6.png text=''
...
- `pic` prst=rect (6744113,2338086) 4994305x3658249 asset=image8.png text=''
- `sp` prst=rect (10556111,5023414) 983848x289366 asset= text=''
- `sp` prst=rect (3221619,3981690) 3028709x212527 asset= text=''
- `sp` prst=rect (3221618,3692323) 3028709x190653 asset= text=''
