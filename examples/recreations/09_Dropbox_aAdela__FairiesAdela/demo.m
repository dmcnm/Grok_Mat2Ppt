%% demo.m — 09_Dropbox_aAdela__FairiesAdela
...
lay_Picture_with_Caption = layouts.get_by_name('Picture with Caption');

%% ===== Slide 1 · Title Slide =====
s = prs.slides().add_slide(lay_Title_Slide);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Fairies'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 2 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Lavender Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 3 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Scilla Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 4 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Delphinium Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 5 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Lilac Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 6 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Daisy Fairy'}, struct("autofit", "none"));
set_shape_box_(sh.item(1), 5.9167, 1.25, 3.75, 2.25);
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 7 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Harebell Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 8 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Rose Fairy'}, struct("autofit", "none"));
set_shape_box_(sh.item(1), 5.8936, 2.75, 2.7731, 0.75);
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 9 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Aster Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 10 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Morning glory Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 11 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Forget-me-not Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 12 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Wild Thyme  Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 13 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Thistle Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 14 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Larkspur Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 15 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Elderberry Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 16 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Blackthorn Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 17 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'White clover Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 18 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Periwinkle  Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 19 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Black Medic Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 20 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Marigold Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));

%% ===== Slide 21 · Picture with Caption =====
s = prs.slides().add_slide(lay_Picture_with_Caption);
sh = s.shapes();
style_title_(sh.item(1).text_frame(), {'Hawthorn Fairy'}, struct("autofit", "none"));
apply_title_run_fonts_(sh.item(1).text_frame(), struct("latin", 'Algerian'));
