%% demo.m — 21_Dropbox_Religion__Rupnik_Saturno_Clericalism
...
sh = s.shapes();
tb = sh.add_textbox(In(0.6591), In(6.436), In(12.0152), In(0.5722));
style_textbox_(tb.text_frame(), 'One of these is a symbol of scandal and clericalism.  The other is a hat.', struct("bullets", false, "align", 'ctr', "autofit", "shape", "pt", 28));
p = add_pic_(sh, assets, 'image1.png', 0.0, 0.4769, 13.3333, 5.9591);
