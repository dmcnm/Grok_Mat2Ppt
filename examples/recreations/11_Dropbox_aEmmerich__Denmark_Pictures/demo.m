%% demo.m — 11_Dropbox_aEmmerich__Denmark_Pictures
...
sh = s.shapes();
p = add_pic_(sh, assets, 'image1.png', 5.9717, 3.13, 1.39, 1.24);
p = add_pic_(sh, assets, 'image2.png', 7.3617, 3.13, 2.926, 1.2438);
