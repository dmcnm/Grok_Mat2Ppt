%% demo.m — 17_Dropbox_Politics__Meme Creation
...
sh = s.shapes();
tb = sh.add_textbox(In(1.149), In(0.6931), In(3.4258), In(0.4376));
style_textbox_(tb.text_frame(), 'What they studied', struct("bullets", false, "autofit", "shape", "pt", 20, "face", 'Abadi', "scheme", 'accent1'));
sp = sh.add_shape('downArrow', In(3.0786), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
sp = sh.add_shape('downArrow', In(3.4043), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
sp = sh.add_shape('downArrow', In(3.73), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
tb = sh.add_textbox(In(5.6035), In(0.6944), In(1.3965), In(0.4376));
style_textbox_(tb.text_frame(), 'The exam', struct("bullets", false, "autofit", "shape", "pt", 20, "face", 'Abadi', "scheme", 'accent1'));
sp = sh.add_shape('downArrow', In(2.7177), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
sp = sh.add_shape('downArrow', In(3.0435), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
sp = sh.add_shape('downArrow', In(3.3692), In(0.6453), In(0.268), In(0.2784));
apply_shape_style_office_(sp);
p = add_pic_(sh, assets, 'image1.jpg', 0.6979, 1.1612, 4.3778, 6.2805);
p = add_pic_(sh, assets, 'image2.jpg', 5.0757, 1.1612, 4.3778, 6.2606);
